...
public class ScoreEx1 {
	...
	public static void main(String[] args) {
		/* 0~100점 사이의 점수를 입력받아
		 *  입력받은 점수의 학점을 출력하는 코드를 작성하세요.
		 * 90이상~100이하 : A
		 * score가 90 보다 크거나같고 score가 100보다 작거나 같으면 A라고 출력
		 * (score가 90 보다 (크거나 같)(고) score가 100보다 (작거나 같다)
		 * 
		 * 80이상~90미만  : B
		 * 70이상~80미만  : C
		 * 60이상~70미만  : D
		...
		System.out.println(" 점수를 입력하세요.(0~100사이의 정수) : ");
