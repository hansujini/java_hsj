...
public class ForLCMEx1 {
	...
	public static void main(String[] args) {
		 ...
		 * 두 정수는 4 와 6
		 * num는 2의 배수 => num % 2 == 0
		 * 최소공배수 4의 배수 6의 배수 중에서 공통되는 가장 작은 수
		 * 방법1   : 무조건 1붜 시작하기 떄문에 num1과 num2가 크면 반복횟수가 많아진다.
		 *          10000과 20000인 경우 10000을 기준으로 10000씩 증가하면 2번이면 되지만
		 *          방법 1은 무조건 1씩 증가하기 때문에 20000만번을 해야 한다.
		 * 반복횟수 : i 는 1 부터 시작해서 num1 * num2까지 1씩 증가
	...
	/* 방법 2  : num1부터 시작해서 num1*num2까지 num1씩 증가
