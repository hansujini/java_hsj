...
public class MethodRandomEx1 {
	 ...
	 * 선생님이 학생에게 " 학생1 정수를 생각해서 나에게 말해주세요."
	 * 학생이 "1에서 10사이의 정수를 선생님에게 알려줌"
	 * 매개변수 : 없음.
	 ...
	 * 선생님 : "학생 1, 1부터 10사이의 정수를 생각해서 칠판에 적으세요"
	 * 학생 : 1에서 10사이의 정수를 칠판에 적음.
	 * 매개변수 : 1(최소값), 10(최대값) => int max, int max
	 * 			선생님이 1과 10이라는 정보는 학생에게 알려줌.
	 * 리턴타입 : 없음. void
	 * 메소드명 : random3
	 * */
