...
public class MethodRandomArrayEx1 {
	...
	public static void main(String[] args) {
		 ...
		 * 작성하세요. 메소드 생성하고 호출할 것. 단, 중복가능 
		 * 기능 : 1에서 45사이의 랜덤한 수를 6개 생성하여 배열에 저장하는 메소드
		 * 매개변수 : 1에서 45사이의 랜덤 수 => int min, int max
		 * 리턴타입 : 있음. => int
		 * 메소드명 : random
		 * */
	 ...
	 * 매개변수 : 배열 , 정수범위(min~max) => int min, int max, int arr[]
	 * 리턴타입 : 없음 void
	 * 메소드명 : randomArray1
	 */
	 ...
	 * 		만들어진 배열을 알려주는 메소드
	 * 매개변수 : 크기, 정수범위(min~max)=> int min, int max, int size
	 * 리턴타입 : 배열 => int[]
	 * 메소드명 : randomArray2
	 * */
