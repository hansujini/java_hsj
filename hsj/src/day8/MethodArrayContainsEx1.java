...
public class MethodArrayContainsEx1 {
	...
	/* 기능 : 배열과 정수가 주어지면 정수가 배열에 있으면 true가 없으면 false를 알려주는 메소드
	 * 매개변수 : 배열, 정수 => int []arr, int num
	 * 리턴타입 : true/false => boolean
	 * 메소드명 : containsArray
	 */
	...
	/* 배열에 1~45사이의 랜덤한 수를 생성하여 6개짜리 배열에 저장하는 코드를 작성하세요.
	 * 단, 중복 불가, 메소드 이용
	 * 기능 : 배열 의 갯수가 주어지면 min~max사이의 랜덤한 정수를 중복되지 않게 생성하여 저장하는 메소드
